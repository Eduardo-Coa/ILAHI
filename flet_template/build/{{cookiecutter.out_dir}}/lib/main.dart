...
class BlankScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Fondo NEGRO (en vez del gris por defecto de Material) para que el arranque
    // —splash negro → esta pantalla → app de tema oscuro— no tenga un destello gris.
    // Personalización de Ilahi sobre la plantilla de build de Flet.
